...
- Added kafka helpers used in multiple projects (#86e6925)

## [4.1.0] - 2026-05-29

### Added/Changed

- Library now pins and hashes versions when developing locally (#3c431ed)
...
- specify dependencies in pyproject.toml (#b8853b6)

## [3.1.0] - 2025-12-04

### Added

- prometheus-style metrics parser (#ddc3b2c)
